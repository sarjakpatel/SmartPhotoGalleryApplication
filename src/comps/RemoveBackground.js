...
const RemoveBackground = () => {
    ...
    const removeBackgroundAPI = "/remove-bg";
    ...
    const handleChange = (e) => {
        ...
        if (selected && types.includes(selected.type)) {
            ...
            const fetchImage = async () => {
                const res = await fetch(removeBackgroundAPI, options);;
    ...
    return (
        <div className="App">
            <Title title="Upload a Image from which you want to remove background"/>
